      ...
      <div className="flex items-start justify-between bg-discord-dark rounded-lg p-3 border border-discord-red/30">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-1">
            Deleting this server will remove all channels and messages. This action cannot be undone.
          </p>
        </div>
        <button
          ...
          title={isOwner ? 'Delete server' : 'Only the owner can delete this server'}
        >
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 px-4">
          <div className="bg-discord-lighter rounded-lg p-6 w-full max-w-md border border-discord-dark">
            ...
            <p className="text-sm text-gray-300 mb-4">
              You are about to delete <span className="font-semibold text-white">{currentServer.name}</span>. This
              will also remove its channels. Type the server name to confirm.
            </p>
