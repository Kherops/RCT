...
import { Hash, Send, MoreVertical, Trash2, Copy, Loader2, MessageSquare, AtSign, Image as ImageIcon, CornerUpLeft, X } from 'lucide-react';
...
export function ChatArea() {
  ...
  useEffect(() => {
    setReplyTarget(null);
  }, [currentChannel?.id, currentDmConversation?.id, mode]);
